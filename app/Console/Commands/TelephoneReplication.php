...
class TelephoneReplication extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cron:telephone_replication';
    ...
    protected $description = 'Replikasi telephone';
    ...
    {
        $transactions = PpobTransaction::where('service', '=', 4)
        ...
        foreach ($transactions as $pulsa) {
            ...
            try {
                ...
                $detail = new PostpaidTelephone;
                $detail->customer_name = $pulsa->phone->customer_name;
                $detail->created_at = $pulsa->created_at;
                $detail->bill_amount = $pulsa->phone->nominal;
                $detail->admin_amount = $pulsa->phone->admin;
                $detail->period = $pulsa->phone->period;
                $detail->reference = $pulsa->phone->ref;
                $detail->supplier_service_code = 'TLP';
                ...
                $postpaid->admin_amount = $pulsa->phone->admin;
                ...
                $postpaid->detailable_type = 'App\Models\Postpaid\PostpaidTelephone';
