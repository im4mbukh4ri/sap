...
class BpjsReplication extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cron:bpjs_replication';
    ...
    {
        $transactions = PpobTransaction::where('service', '=', 9)
        ...
        foreach ($transactions as $pulsa) {
            ...
            try {
                ...
                $detail = new PostpaidInsurance;
                $detail->customer_name = $pulsa->bpjs->customer_name;
                $detail->bill_amount = $pulsa->bpjs->nominal;
                $detail->admin_amount = $pulsa->bpjs->admin;
                $detail->reference = $pulsa->bpjs->ref;
                ...
                $postpaid->admin_amount = $pulsa->bpjs->admin;
                ...
                $postpaid->detailable_type = 'App\Models\Postpaid\PostpaidInsurance';
