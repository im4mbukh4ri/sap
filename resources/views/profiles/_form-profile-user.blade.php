...
?>
<div class="row">
  <form action="{{ route('profiles.user_update_photo',$user) }}" method="POST" enctype="multipart/form-data">
      {{ csrf_field() }}
      {{ Form::hidden('user_id',(isset($travel))?$travel->id:0) }}
  <div class="col-md-3">
      <div class="panel panel-primary panel-click">
          ...
          <div class="panel-body">
              <div class="row">
                  <div class="col-md-12">
                      <img src="{{ asset( (isset($userphoto))?$userphoto->url_photo:'/assets/images/material/default_avatar.jpg') }}" alt="foto-user" class="img-circle">
                  </div>
              </div>
              <hr>
              <div class="row">
                  <div class="col-md-12 text-center">
                      <h3>Foto Profil</h3>
                          <input type="file" name="photo" class="form-control" id="image_file" required>
                          <input type="submit" class="btn btn-blue js-submit-upload" value="Upload">
                  </div>
              </div>
          </div>
      </div>
...
<div class="panel panel-primary panel-click">
    ...
    <div class="panel-body">
        <form action="{{ route('profiles.user_update',$user) }}" method="POST">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <p class="muted">Masukkan password untuk melanjutkan proses.</p>
                </div>
                <div class="col-md-9">
                    {{-- <div class="form-group">
 ...
 --></div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-4">
                                <input type="password" class="form-control" id="CaptchaCodeLogin" name="CaptchaCodeLogin" placeholder="Password">
                            </div>
                        </div>
                    </div>
                </div>
