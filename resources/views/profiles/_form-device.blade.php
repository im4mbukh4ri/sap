                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                <form action="{{route('profiles.reset_device',$client->device_id)}}" method="POST">
                                    {{ csrf_field() }}
                                <img src="{{ asset('/images/logo/devices/'.$client->device_type.'.png') }}" alt="{{$client->device_type}}" class="img-rounded" style="display: block;margin: auto;width: 150px;height: 150px;">
