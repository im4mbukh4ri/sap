        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="blue-title-big">Edit Program Charity</h3>
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <img class="img-responsive" src="{{$datas->url_image}}" style="display: block;margin: auto;">
                                </div>
                            </div>
                            <br>
                            <textarea id="content" name="content">{!! $datas->content !!}</textarea>
                            <div class="form-group">
...
@foreach($statuses as $key => $status)
                            ...
                            <button type="submit" class="btn btn-blue">Save Charity</button>
                            <input type="hidden" name="id_charity" value="{{$datas->id}}">
                            <input type="hidden" name="filename" value="{{$datas->url_image}}">
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <h3 class="blue-title-big">List Pengumuman / Charity</h3>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
