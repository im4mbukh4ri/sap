                                ...
                                <div class="row">
                                    <div class="row">
                                        <div class="col-md-2">
                                            ...
                                            <div class="col-md-2">
                                            <label class="radio-inline">
                                                <input type="radio" name="check" checked id="byPnr" class="show_hide" value="pnr"> <font color="white">Cek Voucher</font>
                                            </label>
                                            </div>      
                                        </div>
                                    <br>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group custom-input">
                                                <input type="text" name="pnr" class="form-control" id="pnr" placeholder="Kode Voucher" value="{{ old('pnr') }}">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                        ...
                        <table id="data-table" class="text-center table table-striped table-bordered dt-responsive nowrap table-custom-blue">
                            ...
                            <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">{{ $booking->room }} Kamar</td>
                                        ...
                                        <td style="text-align: right;">Smart Price : {{(isset($booking->commission))?number_format($booking->total_fare-$booking->commission->member):0 }}<br>
                                            SIP : {{ (isset($booking->commission))?number_format($booking->commission->pusat):0 }}<br>Smart Point : {{ (isset($booking->commission))?number_format($booking->commission->bv):0 }}<br>
