...
@section('content')
	<section id="chooseFlight2" class="main-table" style="padding-bottom: 0">
			<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h3 class="blue-title-big">Detail Transaksi {{ $transaction->pnr }}</h3>
							<br>
						  ...
						  <div class="rows">
								  ...
								  @endif
									@if($transaction->bookings->first()->status=="canceled")
									  <div class="alert-custom alert alert-red alert-dismissible" role="alert">
											<img class="icon-sign" src="{{asset('/assets/images/material/icon-02.png')}}">
											<p><strong>CANCEL</strong><br /><strong>NOTE : {{$transaction->bookings->first()->failed_message->message}}</strong></p>
									  </div>
								  @endif
