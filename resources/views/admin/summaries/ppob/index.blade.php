...
@section('content')
    <section class="section-pilih-seat">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="blue-title-big">SUMMARY PPOB</h3>
                    <div id="dataSearch" class="box-orange">
                        <form action="{{route('admin.operational_summaries_ppob')}}" method="GET">
                            {{csrf_field()}}
...
?>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <form action="{{route('admin.operational_summaries_ppob')}}" method="GET" target="_blank" >
                            {{csrf_field()}}
