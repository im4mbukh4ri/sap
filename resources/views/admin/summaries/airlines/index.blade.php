...
@section('content')
    <section class="section-pilih-seat">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="blue-title-big">SUMMARY MASKAPAI</h3>
                    <div id="dataSearch" class="box-orange">
                        <form action="{{route('admin.operational_summaries_airlines')}}" method="GET">
                            {{csrf_field()}}
...
?>
                                                <select class="form-control full-width" name="limit">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <form action="{{route('admin.operational_summaries_airlines')}}" method="GET" target="_blank" >
                            {{csrf_field()}}
    ...
    <td class="text-right">{{ number_format($summary->total_smart_cash) }}</td>
    <td class="text-right">{{ number_format($summary->total_market_price - $summary->total_smart_cash) }}</td>
                                    </tr>
                            @empty
                                <tr>
