...
@section('content')
    <section class="section-pilih-seat">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="blue-title-big">Data Free Member Pasif</h3>
                    <div id="dataSearch" class="box-orange">
                        <form action="{{route('admin.users_pasif')}}" method="GET">
                            {{csrf_field()}}
                            <div class="row-form">
                                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <form action="{{route('admin.users_pasif')}}" method="GET" target="_blank" >
                            {{csrf_field()}}
