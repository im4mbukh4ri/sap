...
<div class="row">
    <form action="{{ route('admin.users_update_travel',(isset($travel))?$travel->id:'0') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
    ...
    <form action="{{ route('admin.users_update_travel', (isset($travel))?$travel->id:'0' )  }}" method="POST" class="form-horizontal">
        {{ csrf_field() }}
        {{ Form::hidden('travel_id',(isset($travel))?$travel->id:0) }}
    <div class="col-md-9">
        <div class="panel panel-primary panel-click">
...
--></div>
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 control-label">&nbsp;</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="CaptchaCode" name="CaptchaCode" placeholder="Masukan kode akses">
                            </div>
                        </div>
                        <div class="form-group">
