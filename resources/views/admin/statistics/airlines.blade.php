...
@section('content')
    <section class="section-pilih-seat">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="blue-title-big">STATISTIK AIRLINES</h3>
                                ...
                                @if($statistic->count()!=0)
                                    <?php
                                        ...
                                        foreach ($statistic as $value){
                                            ...
                                            $centre[]=ceil($value->transaction_commission->pusat);
                                                if($value->airlines_transaction->device=='android'){
                                                    $android[]=1;
                                                }elseif($value->airlines_transaction->device=='web'){
                                                    $web[]=1;
                                                }else{
                                                    $undefined[]=1;
                                                }
            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="airlinesChart" style="height: 250px;"></div>
                </div>
            </div>
            <div class="row">
