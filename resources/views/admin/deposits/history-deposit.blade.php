...
@section('content')
    <section class="section-pilih-seat">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="blue-title-big">BUKU SALDO MEMBER</h3>
                    <div id="dataSearch" class="box-orange">
                        <form action="{{route('admin.deposits_histories')}}" method="GET">
                            {{csrf_field()}}
                            <div class="row-form">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="whiteFont">Username</label>
                        ...
                        <table id="data-table" class="text-center table table-striped table-bordered dt-responsive nowrap table-custom-blue">
                            ...
                            @forelse($histories as $key => $history)
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{number_format($history->deposit-$history->debit+$history->credit)}}</td>
