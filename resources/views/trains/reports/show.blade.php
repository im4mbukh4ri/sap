			...
			<div class="container">
					<div class="row">
                      ...
                      @foreach ($transaction->bookings as $key => $booking)
                        <div class="row row-resultnya result-berangkat">
                          <div class="col-sm-2 col-md-2 inline-row t1 text-center">
                            <img class="logoFlightFrom-top" width="auto" height="auto" src="{{asset('/assets/logo/kai.png')}}" alt="logo-kai">
                          </div>
                      ...
                      @endforeach
										...
										<div class="col-md-3 nopadding item-result" @if($transaction->trip_type_id=="R")style="height: 171px;"@else style="height: 78px;" @endif>
                  ...
                  <div class="white-box small-flight" style="padding-top: 0">
                    <div class="items-flight-destination">
                      <div class="row-detail">
                        ...
                        ?>
                        <img width="80" src="{{asset('/assets/logo/kai.png')}}" alt="logo-kai">
                        <br>
