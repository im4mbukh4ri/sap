...
<input type="hidden" name="indexDep" value="{{$indexDep}}" />
<input type="hidden" name="cabin" value="{{$cabin}}" id="cabinSelected"/>
            ...
            <div class="col-md-12">
                <div class="seat-table">
                    <div class="title-flight">
                        ...
                        <?php
                        $result['ac']=$result['schedule']['departure'][$indexDep]['ac'];
