                    ...
                    <div id="box-search" class="box-orange">
                        <div class="rows">
                            <label class="radio-inline">
                                <input type="radio" name="trip_railink" id="flight" value="O" <?=(old('trip_railink')=='O')?'checked':''?>> Sekali Jalan
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="trip_railink" value="R" <?=(old('trip_railink')=='R')?'checked':''?>> Pulang Pergi
                            </label>
                        </div>
                                    ...
                                    <div class="input-group custom-input">
                                        ...
                                        <select id="origin" name="origin" class="selectSearch1 full-width" required>
                                            ...
                                            @foreach($railink_stations as $station)
                                                <option value="{{$station['code']}}" <?=(old('origin')==$station['code'])?'selected':''?>>{{$station['city']}} - {{$station['name']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group group-addon-select">
                                    ...
                                    <div class="input-group custom-input">
                                        ...
                                        <select id="destination" name="destination"  class="selectSearch2 full-width">
                                            ...
                                            @foreach($railink_stations as $station)
                                                <option value="{{$station['code']}}" <?=(old('destination')==$station['code'])?'selected':''?>>{{$station['city']}} - {{$station['name']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
