                        ...
                        <table id="data-table" class="text-center table table-striped table-bordered dt-responsive nowrap table-custom-blue">
                            ...
                            @forelse($transactions as $key => $transaction)
                                <tr>
                                    ...
                                    <td>@if($transaction->status=="SUCCESS")<form action="{{ route('ppob.receipt',$transaction) }}" method="GET" target="_blank"><input type="hidden" name="service_fee" class="service_fee" value="0"><button class="btn btn-primary js-submit-confirm" ><i class="fa fa-download"></i></button></form>@endif</td>
                                </tr>
                            @empty
                                <tr>
