...
<!-- STEP BOOKING -->
    ...
    <div id="train">
        ...
        @if($trip=="R")
            {!! Form::open(['route'=>'railinks.booking_form','method'=>'post','id'=>'getClass']) !!}
            {!! csrf_field() !!}
                                    ...
                                    <div class="row nopadding result-row">
                                        <div class="col-md-9 nopadding item-result">
                                            <div class="left-result">
                                                <div class="row row-resultnya result-berangkat" style="height:85px;">
                                                    <div class="col-sm-2 col-md-2 inline-row t1">
                                                        <img class="logoFlightFrom-top" width="auto" height="50px" src="#" title="Citilink" alt="QG-153 DPS HLP 07:25">
                                                    </div>
                                                ...
                                                <div class="row row-resultnya result-pulang" style="height:85px;">
                                                    <div class="col-sm-2 col-md-2 inline-row t1">
                                                        <img class="logoFlightFrom-top" width="auto" height="50px" src="#" title="Citilink" alt="QG-153 DPS HLP 07:25">
                                                    </div>
                                                    <div class="col-sm-4 col-md-4 inline-row">
            ...
            <!-- START LIST AIRLINES -->
            @include('layouts.search-railink')
