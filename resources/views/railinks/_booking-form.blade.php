...
<?php
  ...
  $std=\App\RailinkStation::find($result['org']);
  $sta=\App\RailinkStation::find($result['des']);
...
?>
                ...
                <div class="col-md-12">
                    <div class="rangkuman-table">
                        ...
                        <div class="row nopadding result-row">
                                ...
                                <div class="left-result">
                                    <div class="row row-resultnya result-berangkat">
                                        <div class="col-sm-2 col-md-2 inline-row t1">
                                            <img class="logoFlightFrom-top" width="auto" height="50px" src="{{asset('/assets/logo/railink.png')}}" alt="logo-railink">
                                        </div>
                            ...
                            <div class="col-md-3 nopadding item-result"  @if($result['trip']=="R")style="height: 150px;" @else style="height: 80px;" @endif>
    ...
    <section id="form-customer">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            {!! Form::open(['route'=>'railinks.set_seat','method'=>'post','id'=>'bookingForm']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <input type="text" name="chdName[]" class="form-control" id="chdName" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="white-box small-flight">
                    <div class="items-flight-destination">
                        <div class="row-detail">
                            <img width="80" src="{{asset('/assets/logo/railink.png')}}" alt="logo-railink"><br>
