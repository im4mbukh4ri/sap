          ...
          <img class="header-img" src="{{asset('/images/eticket/img-header.png')}}">
				...
				<div class="content div-table">
					<div class="content div-col">
						<h5>
							<span>Operator</span>
							<span>:</span>
							<span>{{$data->ppob_service->parent->name}}</span>
            </h5>
            <h5>
							<span>Nominal</span>
							<span>:</span>
							<span>{{$data->ppob_service->name}}</span>
            </h5>
						<h5>
            ...
            @else
						<h5 class="content-price">
							...
							<span>:</span>
							<span>IDR</span>
							<span>{{ number_format($data->paxpaid + $data->markup) }}</span>
            </h5>
            @endif
					</div>
				</div>
				...
				<h5>
					<span>SN</span>
					<span>:</span>
					<span>{{ $data->serial_number->serial_number }}</span>
				</h5>
				@endif
			</div>
