	...
	<body>
		<div class="page">
          ...
          <img class="header-img" src="{{asset('/images/eticket/img-header.png')}}">
					...
					<div class="header div-col">
						<h5 class="f-700">Receipt {{ $data->ppob_service->name }}</h5>
						<h5>
				...
				<div class="content div-table">
					<div class="content div-col">
						...
						<h5>
							<span>Name</span>
							<span>:</span>
							<span>{{ $data->finance->customer_name }}</span>
            </h5>
            <h5>
              <span>Pol. Number</span>
              <span>:</span>
              <span>{{ $data->finance->no_polisi }}</span>
            </h5>
            <h5>
              <span>Period</span>
              <span>:</span>
              <span>{{  $data->finance->period }}</span>
            </h5>
						<h5>
							<span>Tenor</span>
							<span>:</span>
							<span>{{  $data->finance->tenor }}</span>
            </h5>
            <h5>
              <span>Ref</span>
              <span>:</span>
              <span>{{ $data->finance->ref }}</span>
            </h5>
					</div>
					<div class="content div-col">
						<h5 class="content-price">
							...
							<span>:</span>
							<span>IDR</span>
							<span> {{ number_format($data->finance->nominal) }}</span>
            </h5>
						<h5 class="content-price">
							<span>Admin's Bank</span>
							<span>:</span>
							<span>IDR</span>
							<span>{{ number_format($data->finance->admin) }}</span>
            </h5>
