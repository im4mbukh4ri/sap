        ...
        <div>
            <table border="0" width="100%">
                <tr>
                    ...
                    <td style="text-align: left; text-transform: uppercase;width: 15%;">: {{  $data->finance->period  }}</td>
                </tr>
                <tr>
                    <td style="text-align: left; text-transform: uppercase"> NAMA</td>
                    <td style="text-align: left; text-transform: uppercase">: {{ $data->finance->customer_name }}</td>
                    <td style="text-align: left; text-transform: uppercase">TENOR</td>
                    <td style="text-align: left; text-transform: uppercase">: {{  $data->finance->tenor }}</td>
                </tr>
                <tr>
                    <td style="text-align: left; text-transform: uppercase">NO. POL</td>
                    <td style="text-align: left; text-transform: uppercase">: {{ $data->finance->no_polisi }}</td>
                    <td style="text-align: left; text-transform: uppercase">RP TAGIHAN</td>
                    <td style="text-align: left; text-transform: uppercase">: RP {{ number_format($data->finance->nominal) }}</td>

                </tr>
                <tr>
                    <td style="text-align: left; text-transform: uppercase">NO. REF</td>
                    <td style="text-align: left; text-transform: uppercase">: {{ $data->finance->ref }}</td>
                    <td style="text-align: left; text-transform: uppercase">ADMIN BANK</td>
                    <td style="text-align: left; text-transform: uppercase">: RP {{ number_format($data->finance->admin) }}</td>
                </tr>
