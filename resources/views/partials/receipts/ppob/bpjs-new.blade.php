	...
	<body>
		<div class="page">
          ...
          <img class="header-img" src="{{asset('/images/eticket/img-header.png')}}">
					...
					<div class="header div-col">
						<h5 class="f-700">Receipt BPJS</h5>
						<h5>
				...
				<div class="content div-table">
					<div class="content div-col">
						...
						<h5>
							<span>Name</span>
							<span>:</span>
							<span>{{ $data->bpjs->customer_name }}</span>
						</h5>
						<h5>
							<span>No. REF</span>
							<span>:</span>
							<span>{{ $data->bpjs->ref }}</span>
						</h5>
					</div>
					<div class="content div-col">
						<h5 class="content-price">
							...
							<span>:</span>
							<span>IDR</span>
							<span> {{ number_format($data->bpjs->nominal) }}</span>
						</h5>
						<h5 class="content-price">
							<span>Admin's Bank</span>
							<span>:</span>
							<span>IDR</span>
							<span>{{ number_format($data->bpjs->admin) }}</span>
            </h5>
