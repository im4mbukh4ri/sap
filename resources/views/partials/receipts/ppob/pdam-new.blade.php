              ...
              <h5>
                ...
                <span>{{ $data->pdam->pdam_name }}</span>
						...
						<h5>
							<span>Name</span>
							<span>:</span>
							<span>{{ $data->pdam->customer_name }}</span>
            </h5>
						<h5>
							<span>Period</span>
							<span>:</span>
							<span>{{  $data->pdam->period  }}</span>
            </h5>
            <h5>
              <span>Ref</span>
              <span>:</span>
              <span>{{ $data->pdam->ref }}</span>
            </h5>
					</div>
					<div class="content div-col">
						<h5 class="content-price">
							...
							<span>:</span>
							<span>IDR</span>
							<span> {{ number_format($data->pdam->nominal) }}</span>
            </h5>
						<h5 class="content-price">
							<span>Admin's Bank</span>
							<span>:</span>
							<span>IDR</span>
							<span>{{ number_format($data->pdam->admin) }}</span>
            </h5>
