	...
	<body>
		<div class="page">
          ...
          <img class="header-img" src="{{asset('/images/eticket/img-header.png')}}">
					...
					<div class="header div-col">
						<h5 class="f-700">Receipt PLN-Prepaid</h5>
						<h5>
				...
				<div class="content div-table">
					<div class="content div-col">
						...
						<h5>
							<span>Name</span>
							<span>:</span>
							<span>{{ $data->pln_pra->customer_name }}</span>
            </h5>
            <h5>
							<span>Category</span>
							<span>:</span>
							<span>{{ $data->pln_pra->golongan_daya }}</span>
						</h5>
						<h5>
							<span>No. REF</span>
							<span>:</span>
							<span>{{ $data->pln_pra->reff }}</span>
            </h5>
            <h5>
                <span>KWH</span>
                <span>:</span>
                <span>{{ $data->pln_pra->kwh }}</span>
            </h5>
					</div>
					<div class="content div-col">
            <h5 class="content-price">
              ...
              <span>:</span>
              <span>IDR</span>
              <span> {{ $data->pln_pra->materai }}</span>
            </h5>
            <h5 class="content-price">
              <span>PPN</span>
              <span>:</span>
              <span>IDR</span>
              <span> {{ number_format($data->pln_pra->ppn) }}</span>
            </h5>
            <h5 class="content-price">
              <span>PPJ</span>
              <span>:</span>
              <span>IDR</span>
              <span> {{ number_format($data->pln_pra->ppj) }}</span>
            </h5>
						<h5 class="content-price">
							<span>IDR Bill</span>
							<span>:</span>
            ...
            <h5 class="content-price">
                ...
                <span>:</span>
                <span>IDR</span>
                <span> {{ number_format($data->pln_pra->rp_token) }}</span>
              </h5>
						<h5 class="content-price">
							<span>Admin's Bank</span>
							<span>:</span>
							<span>IDR</span>
							<span>{{ number_format($data->pln_pra->admin) }}</span>
            </h5>
        ...
        <h3>
            <span>TOKEN</span>
            <span>:</span>
            <span><strong>{{ $data->pln_pra->token }}</strong></span>
        </h3>
			</div>
