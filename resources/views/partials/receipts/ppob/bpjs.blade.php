        ...
        <div>
            <table border="0" width="100%">
                <tr>
                    ...
                    <td style="text-align: left; text-transform: uppercase;width: 15%;">KODE/CABANG</td>
                    <td style="text-align: left; text-transform: uppercase;width: 15%;">: {{  $data->bpjs->kode_cabang  }}/{{  $data->bpjs->nama_cabang  }}</td>
                </tr>
                <tr>
                    <td style="text-align: left; text-transform: uppercase"> NAMA</td>
                    <td style="text-align: left; text-transform: uppercase">: {{ $data->bpjs->customer_name }}</td>
                    <td style="text-align: left; text-transform: uppercase">RP TAGIHAN</td>
                    <td style="text-align: left; text-transform: uppercase">: RP {{ number_format($data->bpjs->nominal) }}</td>
                </tr>
                <tr>
                    <td style="text-align: left; text-transform: uppercase">NO. REF</td>
                    <td style="text-align: left; text-transform: uppercase">: {{ $data->bpjs->ref }}</td>
                    <td style="text-align: left; text-transform: uppercase">ADMIN BANK</td>
                    <td style="text-align: left; text-transform: uppercase">: RP {{ number_format($data->bpjs->admin) }}</td>
                </tr>
