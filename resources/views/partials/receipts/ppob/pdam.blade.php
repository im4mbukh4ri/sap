    ...
    <div style="padding:25px;">
        ...
        <div>
            <table border="0" width="100%">
                <tr>
                    <td style="text-align: left; text-transform: uppercase">PERUSAHAAN</td>
                    <td style="text-align: left; text-transform: uppercase">: {{ $data->pdam->pdam_name }}</td>
                    <td style="text-align: left; text-transform: uppercase;width: 15%;">PERIODE</td>
                    <td style="text-align: left; text-transform: uppercase;width: 15%;">: {{  $data->pdam->period  }}</td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: left; text-transform: uppercase">: RP {{ number_format($data->pdam->nominal) }}</td>
                </tr>
                <tr>
                    <td style="text-align: left; text-transform: uppercase"> NAMA</td>
                    <td style="text-align: left; text-transform: uppercase">: {{ $data->pdam->customer_name }}</td>
                    <td style="text-align: left; text-transform: uppercase">ADMIN BANK</td>
                    <td style="text-align: left; text-transform: uppercase">: RP {{ number_format($data->pdam->admin) }}</td>
                </tr>
                <tr>
                    <td style="text-align: left; text-transform: uppercase">NO. REF</td>
                    <td style="text-align: left; text-transform: uppercase">: {{ $data->pdam->ref }}</td>
