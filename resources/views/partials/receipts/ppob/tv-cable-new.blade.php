				...
				<div class="content div-table">
					<div class="content div-col">
						...
						<h5>
							<span>Name</span>
							<span>:</span>
							<span>{{ $data->phone->customer_name }}</span>
            </h5>
						<h5>
							<span>Period</span>
							<span>:</span>
							<span>{{  $data->phone->period  }}</span>
            </h5>
            <h5>
              <span>Ref</span>
              <span>:</span>
              <span>{{ $data->phone->ref }}</span>
            </h5>
					</div>
					<div class="content div-col">
						<h5 class="content-price">
							...
							<span>:</span>
							<span>IDR</span>
							<span> {{ number_format($data->phone->nominal) }}</span>
            </h5>
						<h5 class="content-price">
							<span>Admin's Bank</span>
							<span>:</span>
							<span>IDR</span>
							<span>{{ number_format($data->phone->admin) }}</span>
            </h5>
