                            ...
                            <div class="white-box">
                                <div class="detail-produk">
                                    ...
                                    <div class="row-group">
                                        ...
                                        <div class="detail-label">IDR @{{ parseInt(resultInquery.total)+parseInt(com) | addCommas }}</div>
                                    </div>
                                    <div class="row-group">
                                        <label>Smart Price</label>
                                        <div class="detail-label">IDR @{{ parseInt(resultInquery.total)+parseInt(com)-parseInt(resultInquery.commission) | addCommas }}</div>
                                    </div>
                                    <div class="row-group">
                                        <label>Status</label>
...
{{--                                            <button  v-on:click="pulsaTransaction" class="btn btn-orange full-width" id="btnBuy">BELI</button>--}}
                                            <button class="btn btn-orange full-width" id="btnBuy" disabled>MAINTENANCE</button>
                                        </div>
                                    </div>
                                </div>
                                <br>
        ...
        var pulsa = new Vue({
                ...
                nominals:function () {
                    if(this.phoneNumber.length>=4){
                        ...
                        switch (this.phoneNumber.substring(0,4)){
                            case '0811':return this.nominals=this.telkomsel;break;case '0812':return this.nominals=this.telkomsel;break;case '0813':return this.nominals=this.telkomsel;break;case '0821':return this.nominals=this.telkomsel;break;case '0822':return this.nominals=this.telkomsel;break;case '0823':return this.nominals=this.telkomsel;break;case '0851':return this.nominals=this.telkomsel;break;case '0852':return this.nominals=this.telkomsel;break;case '0853':return this.nominals=this.telkomsel;break;case '0814':return this.nominals=this.indosat;break;case '0815':return this.nominals=this.indosat;break;case '0816':return this.nominals=this.indosat;break;case '0855':return this.nominals=this.indosat;break;case '0856':return this.nominals=this.indosat;break;case '0857':return this.nominals=this.indosat;break;case '0858':return this.nominals=this.indosat;break;case '0817':return this.nominals=this.xl;break;case '0818':return this.nominals=this.xl;break;case '0819':return this.nominals=this.xl;break;case '0877':return this.nominals=this.xl;break;case '0878':return this.nominals=this.xl;break;case '0895':return this.nominals=this.three;break;case '0896':return this.nominals=this.three;break;case '0897':return this.nominals=this.three;break;case '0898':return this.nominals=this.three;break;case '0899':return this.nominals=this.three;break;case '0831':return this.nominals=this.axis;break;case '0832':return this.nominals=this.axis;break;case '0833':return this.nominals=this.axis;break;case '0838':return this.nominals=this.axis;break;case '0881':return this.nominals=this.smartfren;break;case '0882':return this.nominals=this.smartfren;break;case '0883':return this.nominals=this.smartfren;break;case '0884':return this.nominals=this.smartfren;break;case '0885':return this.nominals=this.smartfren;break;case '0886':return this.nominals=this.smartfren;break;case '0887':return this.nominals=this.smartfren;break;case '0888':return this.nominals=this.smartfren;break;case '0889':return this.nominals=this.smartfren;break;case '9990':return this.nominals=this.bolt;break;case '9991':return this.nominals=this.bolt;break;case '9992':return this.nominals=this.bolt;break;case '9993':return this.nominals=this.bolt;break;case '9994':return this.nominals=this.bolt;break;case '9995':return this.nominals=this.bolt;break;case '9996':return this.nominals=this.bolt;break;case '9997':return this.nominals=this.bolt;break;case '9998':return this.nominals=this.bolt;break;case '9999':return this.nominals=this.bolt;break;default:return this.nominals=[{'value':'','name':'Nomer tidak terdaftar'}];break;
                        }
                    }else{
            ...
            methods:{
                inquery:function(){
                    ...
                    $('#formValidation').show();
                    this.success=false;
                    var endPoint='{{ route('pulsa.inquery') }}';
                    ...
                    if(this.phoneNumber!=null){
                        this.$http.post(endPoint,attributes).then((response)=>{
                            ...
                            this.logo=window.urlLogo+'/'+this.resultInquery.logo;
