...
<div class="tabs-wrapper">
    <ul class="nav classic-tabs tabs-cyan" role="tablist">
        <li class="nav-item">
            <a class="nav-link waves-light active" data-toggle="tab" href="#reqHotelSortSchedule1" role="tab">URL</a>
        </li>
        <li class="nav-item">
            <a class="nav-link waves-light" data-toggle="tab" href="#reqHotelSortSchedule2" role="tab">Parameter</a>
        </li>
    </ul>
</div>
<div class="tab-content card">
    <div class="tab-pane fade in active" id="reqHotelSortSchedule1" role="tabpanel">
        <table class="table table-striped">
            ...
            <tr>
                <th>URL</th>
                <td>{{ route('api.hotels_search_sort') }}</td>
            </tr>
            </tbody>
        </table>
    </div>
    <div class="tab-pane fade" id="reqHotelSortSchedule2" role="tabpanel">
        <table class="table table-striped">
            <thead>
            <tr>
                <th>Parameter</th>
            ...
            <tr>
                <th>next</th>
                <td>YA</td>
                <td>Nomor next hasil dari search sebelumnya.</td>
            </tr>
            <tr>
                <th>sort_by</th>
                <td>YA</td>
                <td>Pilih salah satu. rating, startprice, hotelname.</td>
            </tr>
            <tr>
                <th>type</th>
                <td>YA</td>
                <td>Pilih salah satu. ASC, DESC</td>
            </tr>
            </tbody>
        </table>
    </div>
...
<div class="tabs-wrapper">
    <ul class="nav classic-tabs tabs-cyan" role="tablist">
        <li class="nav-item">
            <a class="nav-link waves-light active" data-toggle="tab" href="#resHotelSortSchedule1" role="tab">Repsonse Berhasil</a>
        </li>
        <li class="nav-item">
            <a class="nav-link waves-light" data-toggle="tab" href="#resHotelSortSchedule2" role="tab">Response Gagal</a>
        </li>
        <li class="nav-item">
            <a class="nav-link waves-light" data-toggle="tab" href="#resHotelSortSchedule3" role="tab">Penjelasan</a>
        </li>
    </ul>
</div>
<div class="tab-content card">
    <div class="tab-pane fade in active" id="resHotelSortSchedule1" role="tabpanel">
                ...
                <code class="language-markup">
{
    ...
    <div class="tab-pane fade" id="resHotelSortSchedule2" role="tabpanel">
            <pre class="code-toolbar" style="height: 500px;">
                <code class="language-markup">
...
------- RESPONSE GAGAL transaction_id salah / tidak ditemukan ----------
{
  "status": {
    ...
    <div class="tab-pane fade" id="resHotelSortSchedule3" role="tabpanel">
        <table class="table table-striped">
            <thead>
            <tr>
                <th>Parameter</th>
