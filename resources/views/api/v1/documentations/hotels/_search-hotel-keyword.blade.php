...
<div class="tabs-wrapper">
    <ul class="nav classic-tabs tabs-cyan" role="tablist">
        <li class="nav-item">
            <a class="nav-link waves-light active" data-toggle="tab" href="#reqHotelKeywordSchedule1" role="tab">URL</a>
        </li>
        <li class="nav-item">
            <a class="nav-link waves-light" data-toggle="tab" href="#reqHotelKeywordSchedule2" role="tab">Parameter</a>
        </li>
    </ul>
</div>
<div class="tab-content card">
    <div class="tab-pane fade in active" id="reqHotelKeywordSchedule1" role="tabpanel">
        <table class="table table-striped">
            ...
            <tr>
                <th>URL</th>
                <td>{{ route('api.hotels_search_keyword') }}</td>
            </tr>
            </tbody>
        </table>
    </div>
    <div class="tab-pane fade" id="reqHotelKeywordSchedule2" role="tabpanel">
        <table class="table table-striped">
            <thead>
            <tr>
                <th>Parameter</th>
            ...
            <tr>
                <th>keyword</th>
                <td>YA</td>
                <td>Keyword hotel yang ingin dicari.</td>
            </tr>
            </tbody>
        </table>
    </div>
...
<div class="tabs-wrapper">
    <ul class="nav classic-tabs tabs-cyan" role="tablist">
        <li class="nav-item">
            <a class="nav-link waves-light active" data-toggle="tab" href="#resHotelKeywordSchedule1" role="tab">Repsonse Berhasil</a>
        </li>
        <li class="nav-item">
            <a class="nav-link waves-light" data-toggle="tab" href="#resHotelKeywordSchedule2" role="tab">Response Gagal</a>
        </li>
        <li class="nav-item">
            <a class="nav-link waves-light" data-toggle="tab" href="#resHotelKeywordSchedule3" role="tab">Penjelasan</a>
        </li>
    </ul>
</div>
<div class="tab-content card">
    <div class="tab-pane fade in active" id="resHotelKeywordSchedule1" role="tabpanel">
                ...
                <code class="language-markup">
{
    ...
    <div class="tab-pane fade" id="resHotelKeywordSchedule2" role="tabpanel">
            <pre class="code-toolbar" style="height: 500px;">
                <code class="language-markup">
...
------- RESPONSE GAGAL transaction_id salah / tidak ditemukan ----------
{
  "status": {
    ...
    <div class="tab-pane fade" id="resHotelKeywordSchedule3" role="tabpanel">
        <table class="table table-striped">
            <thead>
            <tr>
                <th>Parameter</th>
