...
<div class="tabs-wrapper">
    <ul class="nav classic-tabs tabs-cyan" role="tablist">
        <li class="nav-item">
            <a class="nav-link waves-light active" data-toggle="tab" href="#reqAirBook1" role="tab">URL</a>
        </li>
        <li class="nav-item">
            <a class="nav-link waves-light" data-toggle="tab" href="#reqAirBook2" role="tab">Parameter</a>
        </li>
    </ul>
</div>
<div class="tab-content card">
    <div class="tab-pane fade in active" id="reqAirBook1" role="tabpanel">
        <table class="table table-striped">
            ...
            <tr>
                <th>URL</th>
                <td>{{ route('api.airlines_booking') }}</td>
            </tr>
            </tbody>
        </table>
    </div>
    <div class="tab-pane fade" id="reqAirBook2" role="tabpanel">
        <table class="table table-striped">
            <thead>
            <tr>
                <th>Parameter</th>
            ...
            <tr>
                <th>total_fare</th>
                <td>YA</td>
                <td>Total fare (TotalAmount) yang di dapat ketika get_fare </td>
            </tr>
            <tr>
                <th>selectedIDdep</th>
                <td>YA</td>
                <td>Selected ID Departure yang didapat ketika get_fare</td>
            </tr>
            <tr>
                <th>selectedIDret</th>
                <td>TIDAK</td>
                <td>Selected ID Return yang didapat ketika get_fare. WAJIB diisi jika penerbangan return</td>
            </tr>
            <tr>
...
<div class="tabs-wrapper">
    <ul class="nav classic-tabs tabs-cyan" role="tablist">
        <li class="nav-item">
            <a class="nav-link waves-light active" data-toggle="tab" href="#resBook1" role="tab">Repsonse Berhasil</a>
        </li>
        <li class="nav-item">
            <a class="nav-link waves-light" data-toggle="tab" href="#resBook2" role="tab">Response Gagal</a>
        </li>
        <li class="nav-item">
            <a class="nav-link waves-light" data-toggle="tab" href="#resBook3" role="tab">Penjelasan</a>
        </li>
    </ul>
</div>
<div class="tab-content card">
    <div class="tab-pane fade in active" id="resBook1" role="tabpanel">
                ...
                <code class="language-markup">
{
    ...
    <div class="tab-pane fade" id="resBook2" role="tabpanel">
            <pre class="code-toolbar" style="height: 500px;">
                <code class="language-markup">
...
------------- RESPONSE GAGAL TETAPI DATA TETAP TERSIMPAN --------------
{
    ...
    <div class="tab-pane fade" id="resBook3" role="tabpanel">
        <table class="table table-striped">
            <thead>
            <tr>
                <th>Parameter</th>
